...
git add README.md docs .gitignore first_ml_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[first_ml_project/databricks.yml](../first_ml_project/databricks.yml) file.
...
Follow the instructions in [first_ml_project/resources/README.md](../first_ml_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../first_ml_project/resources/README.md)  to propose, test, and deploy
