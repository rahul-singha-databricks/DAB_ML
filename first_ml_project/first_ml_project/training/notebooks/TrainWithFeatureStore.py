...
# ``first_ml_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-first_ml_project-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.first_ml_project.first_ml_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.first_ml_project.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.first_ml_project.trip_dropoff_features",
