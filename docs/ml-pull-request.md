...
Opening a pull request will trigger a[workflow](../.github/workflows/first_ml_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/first_ml_project/first_ml_project-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/first_ml_project/first_ml_project-model)
. 
